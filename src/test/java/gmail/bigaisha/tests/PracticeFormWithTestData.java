...
import static gmail.bigaisha.tests.TestData.email;

public class PracticeFormWithTestData {
    static String  firstName = "Bigaisha";
    static String lastName = "Shalabayeva";
